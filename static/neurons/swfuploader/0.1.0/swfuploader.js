...
var _0 = "swfuploader@0.1.0/src/swfu.js";
var asyncDepsToMix = {};
...
SWFUpload.prototype.initSettings = function() {
    ...
    this.ensureDefault("overload_slice", false);
    ...
    // Button Settings
    this.ensureDefault("button_style", 0);
...
SWFUpload.prototype.getFlashVars = function() {
    ...
    return ["movieName=", encodeURIComponent(this.movieName),
            ...
            "&amp;buttonStyle=", encodeURIComponent(this.settings.debug_enabled),
            ...
            "&amp;overloadSlice=", encodeURIComponent(this.settings.overload_slice)
        ].join("");
};
...
SWFUpload.prototype.stopUpload = function() {
    this.debug("stopUpload is called");
...
/**
 * @ setButtonStyle change style of button
...
//        console.log(errorCode+"msg:"+message);
    file = this.unescapeFilePostParams(file);
